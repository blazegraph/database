 ...
 * 
 * @todo the sketch of the commit protocol api needs to be encapsulated by
 *       another interface layering the basic access to the store. the commit
 *       protocol relies on the use of root blocks that are not part of the
 *       basic abstraction of an append-only store.
 * 
