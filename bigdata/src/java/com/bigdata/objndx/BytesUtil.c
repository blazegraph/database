...
javac src/java/com/bigdata/objndx/BytesUtil.java

javah -classpath src/java com.bigdata.objndx.BytesUtil
...
java -classpath src/java com.bigdata.objndx.BytesUtil
...
#include <jni.h>
#include <stdio.h>
#include "com_bigdata_objndx_BytesUtil.h"
 ...
 */
JNIEXPORT jint JNICALL Java_com_bigdata_objndx_BytesUtil__1compareBytes
 ...
 * first argument is less than, equal to, or greater than the second.
 */
JNIEXPORT jint JNICALL Java_com_bigdata_objndx_BytesUtil__1compareBytesWithOffsetAndLen
