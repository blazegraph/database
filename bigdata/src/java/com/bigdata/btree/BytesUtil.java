...
//    }
     ...
     * </p>
     * <p>
     * Separator keys separate leaves and must be chosen with that purpose in
     ...
     * separator keys may be chosen by defining the separator key as the
...
//            sb.append(Integer.toHexString(key[i] & 0xff));
    ...
    private static transient final String NULL = "null";
    ...
    /**
     * Decode a string representation of an <code>unsigned byte[]</code> as
     * generated by {@link #toString()}. This is mainly useful when decoding
     * keys in a log file. Acceptable inputs have the following general form:
     * 
     * <pre>
     * array := '[' v tail ']'
     * v := 0-255
     ...
     * 
     * @param a
     *            The representation of the <code>unsigned byte[]</code>.
     * 
     * @return The <code>unsigned byte[]</code>
     * 
     * @throws IllegalArgumentException
     *             if the argument is <code>null</code>.
     * @throws NumberFormatException
     *             if the values in the array are not integers.
     * @throws NumberFormatException
     *             if the values in the array lie outside of the numeric range
     *             of an unsigned byte.
     */
    static public byte[] fromString( String s) {
        ...
        while (Character.isWhitespace(s.charAt(start)) && start < end) {
            start++;
        }
        ...
        final String[] t = comma.split(s);
        final int n = t.length;
//        System.err.println("input: '" + s + "'");
//        System.err.println("n: " + n);

//        final Matcher m = arrayPattern.matcher(s);
//        if (!m.matches())
//            throw new NumberFormatException();
//        final int n = m.groupCount();
//        System.err.println("input: '" + s+"'");
//        System.err.println("ngroups=" + n + ", matcher: " + m);
...
//            final String x = m.group(i + 1);
            
            final String x = t[i].trim();
            
//            System.err.print("'"+x+"'");
            
            final int j = Integer.parseInt(x);
            
//            System.err.print("("+j+")");

            if (j < 0 || j > 255)
                throw new NumberFormatException("Not an unsigned byte: " + x);

            final byte b = (byte) (j & 0xff);
