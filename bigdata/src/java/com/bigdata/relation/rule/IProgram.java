...
public interface IProgram extends Serializable {
    ...
    /**
     * <code>true</code> iff the {@link #steps()} should be executed in
     * parallel. When <code>false</code> the steps WILL be executed
     * sequentially and (for mutation) the buffered writes will be flushed after
     * each step.
     */
    boolean isParallel();
     ...
     *       <p>
     *       alternatively consider handling closure via a variant of
     *       {@link Program#addStep(IProgram)} with an optional boolean and
     *       (possibly) removing it from this interface.
     */
    boolean isClosure();
