...
import com.bigdata.service.mapred.AbstractJobAndTaskService.AbstractTaskWorker;
...
public class JobState<M> {
     ...
     */
    public Map<UUID, Future<Object>> futures = new ConcurrentHashMap<UUID, Future<Object>>();
     ...
     * FIXME reduce visibility - exposed for some unit tests.
     */
    public BlockingQueue<Outcome> outcomes = new LinkedBlockingQueue<Outcome>(/*no capacity limit*/);
