...
public class MasterJournal {
	...
	private ArrayList<IHAClient> m_directSlaves = new ArrayList<IHAClient>();
	...
	public void addSlave(IHAClient slave) {
	 ...
	 */
	public void writeCache(WriteCache wc) {
	 ...
	 */
	public void prepare(IRootBlockView rootBlock) {
