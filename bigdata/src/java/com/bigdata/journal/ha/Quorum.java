...
//    <T> void applyNext(RunnableFuture<T> r);
    ...
    /**
     * Message invalidates the quorum. This message is generated by the
     * {@link QuorumManager} when the {@link Quorum} has been broken or when
     * this node leaves the {@link Quorum} (including when it is shutdown).
     */
    void invalidate();
