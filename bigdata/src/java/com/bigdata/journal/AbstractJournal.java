 ...
 */
public class AbstractJournal implements IRawStore, IAtomicStore, IStore {
...
//    }
    ...
    /**
     * Option controls whether the journal forces application data to disk before
     * updating the root blocks.
     */
...
//    private long lastBegunTx = -1;
     ...
     */
    public AbstractJournal(Properties properties) throws IOException {
...
//    }
    ...
    public void commit() {
         ...
         * blocks.  This option guarentees that the application data is stable
         * on the disk before the atomic commit.  Some operating systems and/or
         * file systems may otherwise choose an ordered write with the consequence
