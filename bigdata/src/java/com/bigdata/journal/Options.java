...
public class Options {
    ...
    /**
     * <code>forceWrites</code> - When true, the journal file is opened in
     * a mode where writes on the {@link FileChannel} are written through to
     * disk immediately. The use of this option is not recommended unless
     * the journal is using a page cache to improve write performance. Note
     * that this option does NOT provide any additional data safety.
     */
    ...
    /**
     * The default for the {@link #FORCE_WRITES} option.
     */
    public final static boolean DEFAULT_FORCE_WRITES = false;
