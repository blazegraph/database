 ...
 * @version $Id$
 * 
 * @todo why does this extend {@link Comparable}? For testing the names? We use
 *       equals for that....
 */
public interface IVariableOrConstant<E> { //extends Comparable<IVariableOrConstant<E>> {
     ...
     * 
     * @todo generic type for the value.
     */
    E get();
