        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < resources.length; i++) {
                    ...
                    final IndexMetadata sourceIndexMetadata = src
                            .getIndexMetadata();
                     ...
                     */
                    if (!BytesUtil.bytesEqual(leftSeparator, pmd
                            .getLeftSeparatorKey())) {

                        throw new RuntimeException(
                                "Partitions out of order: names="
                                        + Arrays.toString(resources)
                                        + ", have=" + Arrays.toString(oldpmd)
                                        + ", found=" + pmd);
...
//                        , summary+" "
    ...
    static protected class AtomicUpdateJoinIndexPartition extends
        ...
        public AtomicUpdateJoinIndexPartition(ResourceManager resourceManager,
                String[] resource, JoinResult result, Event updateEvent) {
        ...
        protected Void doTask() throws Exception {
            ...
            try {
                ...
                final String scaleOutIndexName = btree.getIndexMetadata()
                        .getName();
