...
//        String CONSTRAINTS = (PipelineJoin.class.getName() + ".constraints").intern();
	 ...
	 */
	public static class PipelineJoinStats extends BaseJoinStats {
         ...
         * <p>
         * Note: This counter is highly correlated with {@link BOpStats#unitsIn}
         * but is incremented only when we begin evaluation of the
         ...
         * <p>
         * Note: This counter is highly correlated with
         * {@link BOpStats#unitsOut}.
         */
