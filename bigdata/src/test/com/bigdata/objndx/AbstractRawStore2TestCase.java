...
/**
 * Base class for writing tests of the {@link IRawStore2} interface.
 * 
...
abstract public class AbstractRawStore2TestCase extends TestCase2 {
    ...
    abstract protected IRawStore2 getStore();
    
    /**
     * True iff the implementation of {@link IRawStore2#delete(long)} is such
     * that a subsequent {@link IRawStore2#read(long, ByteBuffer)} with the same
     * {@link Addr address} will throw an exception. This is not supported by
     * all stores.
     * 
     * @return true iff delete invalidates the address.
     */
    abstract protected boolean deleteInvalidatesAddress();
