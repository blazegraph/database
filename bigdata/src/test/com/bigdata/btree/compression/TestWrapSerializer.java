 ...
 * @version $Id$
 */
public class TestWrapSerializer extends TestCase2 {

//    protected final Logger log = Logger.getLogger(TestWrapSerializer.class);
    
    /**
     * 
     */
    public TestWrapSerializer() {
    }

    /**
     * @param arg0
     */
    public TestWrapSerializer(String arg0) {
        super(arg0);
    }

    final Random r = new Random();

    public void test_WrapCompression_Empty() throws IOException {
    ...
    public void test_WrapCompression_1() throws IOException {
    ...
    public void test_WrapCompression_2() throws IOException {
    ...
    public void test_WrapCompressionOnceRandom() throws IOException {
    ...
    public void doRoundTripTest(IRaba raba) throws IOException {
        ...
        final IDataSerializer serializer = new WrapSerializer(
            DefaultDataSerializer.INSTANCE,
