...
public class TestAll extends TestCase {
    ...
    public static Test suite()
    {
        ...
        /*
         * @todo refactor the btree tests that depend on the journal for testing
         * scale into a different test suite so that we can test the atomic store
         * and restart-safe features of the journal before getting into testing of
         * the btrees integrated with the journal.
         */
