 ...
 * and that the parent reference on a clean child was updated to point to the
 * cloned parent when the child is "stolen" by the cloned parent.
 * 
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 * 
 *          TODO This adds very little to {@link TestDirtyIterators}, which
 *          could simply be modified to also verify the appropriate reference
 *          changes when copy-on-write is triggered.
 */
public class TestCopyOnWrite extends AbstractHTreeTestCase {
