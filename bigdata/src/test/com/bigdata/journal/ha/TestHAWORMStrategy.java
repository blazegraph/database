 ...
 * @version $Id$
 */
public class TestHAWORMStrategy extends AbstractHAJournalTestCase {

    public TestHAWORMStrategy() {
        super();
    }

    public TestHAWORMStrategy(String name) {
        super(name);
    }

    public static Test suite() {

        final TestHAWORMStrategy delegate = new TestHAWORMStrategy(); // !!!! THIS CLASS !!!!
...
//        /*
//         * HA bootstrap test (non-proxied).
//         */
//        suite.addTestSuite(TestHAJournalBootstrap.class);
        ...
        suite.addTestSuite(TestHAWORMStrategy.class);
