...
/**
 * Test suite for {@link BufferMode#BufferedDisk} journals.
 * 
 * @author <a href="mailto:thompsonbry@users.sourceforge.net">Bryan Thompson</a>
 * @version $Id$
 */
public class TestBufferedDiskJournal extends AbstractJournalTestCase {

    public TestBufferedDiskJournal() {
        super();
    }

    public TestBufferedDiskJournal(String name) {
        super(name);
    }

    public static Test suite() {

        final TestBufferedDiskJournal delegate = new TestBufferedDiskJournal(); // !!!! THIS CLASS !!!!
        ...
        ProxyTestSuite suite = new ProxyTestSuite(delegate,
                "Buffered Disk Journal Test Suite");
        ...
        suite.addTestSuite(TestBufferedDiskJournal.class);
    ...
    public Properties getProperties() {
        ...
        properties.setProperty(Options.BUFFER_MODE, BufferMode.BufferedDisk.toString());
     ...
     * using {@link BufferMode#BufferedDisk}.
     * 
     * @throws IOException
     */
...
//                bufferStrategy.file.toString());
        ...
        assertEquals(Options.BUFFER_MODE, BufferMode.BufferedDisk,
                bufferStrategy.getBufferMode());
    ...
    public static class TestRawStore extends AbstractRestartSafeTestCase {
        ...
        protected BufferMode getBufferMode() {
            ...
            return BufferMode.BufferedDisk;
    ...
    public static class TestInterrupts extends AbstractInterruptsTestCase {
        ...
        protected IRawStore getStore() {
            ...
            properties.setProperty(Options.BUFFER_MODE, BufferMode.BufferedDisk
                    .toString());
