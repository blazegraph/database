...
public class BigdataConnection implements ServerConnection{
	...
	private static Logger logger = Logger.getLogger( BigdataConnection.class );
	private int timeout;
    
    /**
     * Modified by MRP 1/19/10.  Used to supply query connections to clients.
     */
    private BigdataSailRepository repo;
    
    /**
     * Modified by MRP 1/19/10.  Accepts a SAIL as a parameter now and 
     * initializes a static repository to be used to supply query connections
     * to clients.
     */
	public BigdataConnection(BigdataSailRepository repo, String defaultGraph, int timeout) {
	    this.repo = repo;
