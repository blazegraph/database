...
/**
 * A SPARQL static analysis error.
 * 
...
public class SparqlDynamicErrorException extends W3CQueryLanguageException {
     ...
     */
    public SparqlDynamicErrorException(int errorCode) {
     
        super(LanguageFamily.SP, ErrorCategory.DY, errorCode, null/* msg */);
