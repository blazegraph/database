 ...
 * 
 * @todo refactor all aspects of TM into this class and out of the subclass.
 * 
 * @todo refactor SAILs into their own project.
 * 
 * @todo update any test suites that depend on TM assumptions.
 * 
 * @todo minimize requirements for the Sesame API outside of the RIO parser.
 * 
