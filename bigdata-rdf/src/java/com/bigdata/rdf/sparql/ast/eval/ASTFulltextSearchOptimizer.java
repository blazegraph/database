 ...
 * @version $Id$
 */
public class ASTFulltextSearchOptimizer implements IASTOptimizer {

    private static final Logger log = 
       Logger.getLogger(ASTFulltextSearchOptimizer.class);
    
    /**
     * The known search URIs.
     * <p>
     * Note: We can recognize anything in {@link Solr#SEARCH_NAMESPACE}, but the
...
//                if (group.getContext() != null)
    ...
    private ServiceNode createServiceNode(final AST2BOpContext ctx,
        ...
        iv.setValue(ctx.db.getValueFactory().asValue(FTS.SEARCH));
