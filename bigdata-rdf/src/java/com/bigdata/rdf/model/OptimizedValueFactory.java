...
public class OptimizedValueFactory implements ValueFactory {
    ...
    /**
     * Method returns a {@link Value} having the same data but whose term
     * identifier is set to {@link #NULL}. This is required when using a
     * {@link Value} generated by one {@link LexiconRelation} on another
     * database using a different {@link LexiconRelation} since the assigned
     * term identifiers for two databases are, in general, not consistent.
     * 
     * @param v
     *            Some value.
     * 
     * @return A value with the same data but cleared term identifier.
     */
    final public BigdataValue newValue(BigdataValue v) {
...
//    private final AtomicLong _ID = new AtomicLong(0L); 
     ...
     * the {@link Term2IdTupleSerializer}.
     * </p>
     * <p>
...
//        public int count = 0;
        ...
        /**
         * Return the term code as defined by {@link ITermIndexCodes} for this
...
//                    + ", known=" + known + "}";
     ...
     * @version $Id$
     */
    public static class TermIdComparator2 implements Comparator<Long> {
    ...
    final public static class _BNode extends _Resource implements BigdataBNode {
        ...
        /**
         * @return {@link ITermIndexCodes#TERM_CODE_BND}.
         */
        ...
        public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
            ...
            deserialize(VERSION0, ITermIndexCodes.TERM_CODE_BND, in);
            
        }

        public void writeExternal(ObjectOutput out) throws IOException {

            serialize(VERSION0, ITermIndexCodes.TERM_CODE_BND, out);
    ...
    final public static class _Literal extends _Value implements BigdataLiteral {
        ...
        /**
         * One of the values defined by {@link ITermIndexCodes} to identify the
         * distinct kinds of RDF literal:
         * <ul>
         * <li>{@link ITermIndexCodes#TERM_CODE_LIT plain literal}</li>
         * <li>{@link ITermIndexCodes#TERM_CODE_LCL language code literal}</li>
         * <li>{@link ITermIndexCodes#TERM_CODE_DTL datatype literal}</li>
         * </ul>
        ...
        public _Literal(String label) {
            ...
            this.code = ITermIndexCodes.TERM_CODE_LIT;
        ...
        public _Literal(String label, String language) {
            ...
            if (language.length() == 0) {
                ...
                this.code = ITermIndexCodes.TERM_CODE_LCL;
        ...
        public _Literal(String label, _URI datatype) {
            ...
            this.code = ITermIndexCodes.TERM_CODE_DTL;
        ...
        public boolean equals(Object o) {
            ...
            if (code == ITermIndexCodes.TERM_CODE_LIT) {

                return true;

            } else if (code == ITermIndexCodes.TERM_CODE_LCL) {

                // check language code.
                return language.equals(oval.language);

            } else if (code == ITermIndexCodes.TERM_CODE_DTL) {
    ...
    final public static class _URI extends _Resource implements BigdataURI {
        ...
        /**
         * @return {@link ITermIndexCodes#TERM_CODE_URI}.
         */
        public byte getTermCode() {
        ...
        public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
            ...
            deserialize(VERSION0, ITermIndexCodes.TERM_CODE_URI, in);
            
        }

        public void writeExternal(ObjectOutput out) throws IOException {

            serialize(VERSION0, ITermIndexCodes.TERM_CODE_URI, out);
        ...
        protected void serialize(short version, byte termCode, DataOutput out)
            ...
            assert termCode == ITermIndexCodes.TERM_CODE_URI;
