...
/**
 * Provides backward chaining for property collection on owl:sameAs for the
 * SP? and S?? access paths.
 * <p>
 ...
 */ 
public class BackchainOwlSameAsPropertiesSPIterator implements ISPOIterator {
    
    private AbstractTripleStore db;
    private long sameAs;
    private ISPOIterator src, sameAs2It, sameAs3It;
     ...
     *            database.
     */
    public BackchainOwlSameAsPropertiesSPIterator(ISPOIterator src, long s, long p,
        ...
        /*
         * Collect up additional properties (p and o values) for the 
         * known s value by examining the values which are owl:sameAs s.  The 
     ...
     * o is unbound in this access path.
     * 
     * @param spo 
