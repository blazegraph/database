 ...
 * <p>
 * Note: This is a relatively straightforward access path because both values
 * of interest for owl:sameAs (s and o) are known up front.  We can collect up
 * all the sames in the ctor and use links between those sames to infer new 
 * links between the original s and o. 
 * 
 * @see InferenceEngine
 ...
 */ 
public class BackchainOwlSameAsPropertiesSPOIterator implements ISPOIterator {
    
    private long sameAs;
    private ISPOIterator src, sameAs2and3It;
     ...
     *            database.
     */
    public BackchainOwlSameAsPropertiesSPOIterator(ISPOIterator src, long s, long p,
        ...
        /*
         * We are essentially taking a cross product of the two sets 
         * {s, ? sameAs s} and {o, ? sameAs o}, then doing a query for all the
         * links between the {s,o} tuples, and using those links to infer links
    ...
    {
        src.close();
        if(sameAs2and3It!=null) sameAs2and3It.close();
