...
public class BackchainTypeResourceIterator implements
	...
	public static class PushbackIterator<E> implements Iterator<E>,
		...
		/**
		 * When non-<code>null</code>, this element was pushed back and is the
	...
	private static class BackchainSTypeResourceIterator implements
			IChunkedOrderedIterator<ISPO> {
		...
		private void testSPO(ISPO spo) {
			...
			if (spo.s().equals(s) && spo.p().equals(rdfType)
					&& spo.o().equals(rdfsResource)) {
				appender = null;
			}
		}
