...
//    /**
//     * Private key builder for the SPO, POS, or OSP keys.
//     * <p>
//     * Note: the caller's thread is in scope when this object is
//     * constructed but we use the keyBuilder inside of a thread
//     * that is assigned once the task begins to run so
//     * {@link AbstractTripleStore#getKeyBuilder()} will not work
//     * here.
//     */
//    private final RdfKeyBuilder keyBuilder = new RdfKeyBuilder(new KeyBuilder(N * Bytes.SIZEOF_LONG));
     ...
     *            counting).
     */
    SPOIndexWriter(AbstractTripleStore statementStore, SPO[] a, int numStmts,
            boolean clone, KeyOrder keyOrder, ISPOFilter filter,
        ...
        this.ndx = statementStore.getStatementIndex(keyOrder);
...
//        this.keys = new byte[numStmts][];
    ...
    public Long call() throws Exception {
        ...
        /*
         * Note: this must not be resolved until the task is
         * executing in its assigned thread.
         */
