...
public class SPOIndexRemover implements Callable<Long> {
    ...
    public SPOIndexRemover(AbstractTripleStore db, SPO[] stmts, int numStmts,
            KeyOrder keyOrder, boolean clone, AtomicLong sortTime,
    ...
    public Long call() throws Exception {
        ...
        for (int i = 0; i < numStmts; i++) {
            ...
            final byte[] key = keyBuilder.statement2Key(keyOrder, spo);
