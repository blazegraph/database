 ...
 * @version $Id$
 */
public class TestTripleStoreLoadRateLocalIsolated extends TestLocalTripleStoreWithIsolatableIndices {

    /**
     * 
     */
    public TestTripleStoreLoadRateLocalIsolated() {
        super();
    }
     ...
     * @param arg0
     */
    public TestTripleStoreLoadRateLocalIsolated(String arg0) {
        super(arg0);
    }
...
//        store.getInferenceEngine().computeClosure(null/*focusStore*/);
    ...
    public void test_U10() {
        ...
        try {
            ...
            new ConcurrentDataLoader(store, 3/*nthreads*/, 10000 /*bufferCapacity*/,  new File(
