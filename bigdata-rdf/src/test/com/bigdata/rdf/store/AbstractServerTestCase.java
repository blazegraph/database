 ...
 * </pre>
 * 
 * FIXME This is <strong>Replicated from the bigdata project</strong> since
 * the test suites are not otherwise made available to other projects in the
 * generated jars.  Make that replication process automatic or keep this in
 * sync!
 * 
