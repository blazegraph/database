 ...
 * @version $Id$
 */
public class TestRuleRdfs11 extends AbstractInferenceEngineTestCase {
...
//        store.fullForwardClosure();
        ...
        SPOBuffer buffer = new SPOBuffer(tmpStore,capacity,distinct);
        
        // apply the rule.
        store.rdfs11.apply(stats, buffer);
        
        // dump entailments on the console.
        buffer.dump(store);
        
        assertEquals("numComputed",stats.numComputed,1);
         ...
         * store.
         */
        assertEquals("#copied",1,store.copyStatements(tmpStore));
