 ...
 * @version $Id$
 */
public class BryanMagicPredicate implements IPredicate<IMagicTuple> {
    ...
    /**
     * The name of this magic predicate.
     */
     ...
     * @param terms
     */
    public BryanMagicPredicate(String relationName, String predicateName, 
     ...
     * @param terms
     */
    public BryanMagicPredicate(String relationName, ISolutionExpander expander, 
            String predicateName, IVariableOrConstant<Long>... terms) {
     ...
     * @param terms
     */
    public BryanMagicPredicate(String[] relationName, //
     ...
     */
    protected BryanMagicPredicate(BryanMagicPredicate src, String[] relationName) {
        ...
        this.predicateName = src.predicateName;
     ...
     */
    protected BryanMagicPredicate(final BryanMagicPredicate src, final int partitionId) {
    ...
    public BryanMagicPredicate asBound(IBindingSet bindingSet) {
        ...
        return new BryanMagicPredicate(relationName, partitionId, 
                constraint, expander, predicateName, 
                terms.toArray(new IVariableOrConstant[terms.size()]));
        
    }

    public BryanMagicPredicate setRelationName(String[] relationName) {

        return new BryanMagicPredicate(this, relationName);
        
    }
    
    public BryanMagicPredicate setPartitionId(int partitionId) {

        return new BryanMagicPredicate(this, partitionId);
