...
/**
 * Servlet for building indexes.
 * 
 */
public class IndexServlet extends BigdataServlet {
    ...
    static private final transient Logger log = Logger.getLogger(IndexServlet.class); 
