 ...
 */
public class FreebaseVocabularySmall extends BigdataCoreVocabulary_v20160317 {

    /**
     * De-serialization ctor.
     */
    public FreebaseVocabularySmall() {
     ...
     */
    public FreebaseVocabularySmall(final String namespace) {
