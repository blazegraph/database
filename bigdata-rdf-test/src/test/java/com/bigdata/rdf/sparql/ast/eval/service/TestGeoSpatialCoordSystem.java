 ...
 * @version $Id$
 */
public class TestGeoSpatialCoordSystem extends AbstractDataDrivenSPARQLTestCase {

    /**
     * 
     */
    public TestGeoSpatialCoordSystem() {
    }

    /**
     * @param name
     */ 
    public TestGeoSpatialCoordSystem(String name) {
        super(name);
    }
