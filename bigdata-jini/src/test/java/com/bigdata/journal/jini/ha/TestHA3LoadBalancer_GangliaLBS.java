 ...
 */
public class TestHA3LoadBalancer_GangliaLBS extends AbstractHA3LoadBalancerTestCase {

    public TestHA3LoadBalancer_GangliaLBS() {
    }

    public TestHA3LoadBalancer_GangliaLBS(final String name) {
