...
public interface SyntaxTreeBuilderConstants {
  ...
  int SAFE_CHAR2 = 165;
  /** RegularExpression Id. */
  int SAFE_CHAR_LONG1 = 166;
  /** RegularExpression Id. */
  int SAFE_CHAR_LONG2 = 167;
  /** RegularExpression Id. */
  int ECHAR = 168;
  /** RegularExpression Id. */
  int HEX = 169;
  ...
  int NUM = 171;
  /** RegularExpression Id. */
  int PN_CHARS_BASE = 172;
  /** RegularExpression Id. */
  int PN_CHARS_U = 173;
  /** RegularExpression Id. */
  int PN_START_CHAR = 174;
  /** RegularExpression Id. */
  int VAR_CHAR = 175;
  /** RegularExpression Id. */
  int PN_END_CHAR = 176;
