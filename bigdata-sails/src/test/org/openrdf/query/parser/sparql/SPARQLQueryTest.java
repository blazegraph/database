...
public abstract class SPARQLQueryTest extends TestCase {
    ...
    /*
     * FIXME This method was obtain a 2nd connection which it was not using.
     * That was causing bigdata tail deadlock as it does not support concurrent
     * connections in the sail yet (there is a semaphore). We can remove this
     * class once we fix that issue.
     */
