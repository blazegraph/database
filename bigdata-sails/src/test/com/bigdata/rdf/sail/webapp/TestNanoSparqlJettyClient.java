...
//				"test.*.*", TestMode.quads);
	...
	public void testExecutorService() throws InterruptedException {
		final int start = Thread.activeCount();
		System.err.println("Start threads " + start);
	...
	public void test976() throws Exception {
		doStressDescribeTest("GET", RDFFormat.RDFXML, 10000 /** tasks **/, 50 /** threads **/, 500 /** statements **/);
	}
